...
class SentenceTokenizer(object):
    def __init__(self):
        self.kkma = Kkma()
        self.okt = Okt()
        self.stopwords = ['중인' ,'만큼', '마찬가지', '꼬집었', '아', '휴', '아이구', '아이쿠', '아이고', '어', '나', '우리', '저희', '따라', '의해', '을', '를', '에', '의', '가',]
...
fData = open('F:/Project AIVIS/AIVIS/src/AIVIS/data.txt', 'r')
fSummarize = open('F:/Project AIVIS/AIVIS/src/AIVIS/summarize.txt', 'w')
fKeywords = open('F:/Project AIVIS/AIVIS/src/AIVIS/keywords.txt', 'w')
